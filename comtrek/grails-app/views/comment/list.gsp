			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="writing_date" title="${message(code: 'comment.writing_date.label', default: 'Writingdate')}" />
					
						<th><g:message code="comment.event.label" default="Event" /></th>
					
						<th><g:message code="comment.participant.label" default="Participant" /></th>
					
						<th><g:message code="comment.trek.label" default="Trek" /></th>
				...
				<g:each in="${commentInstanceList}" status="i" var="commentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${commentInstance.writing_date}" /></td>
					
						<td>${fieldValue(bean: commentInstance, field: "event")}</td>
					
						<td>${fieldValue(bean: commentInstance, field: "participant")}</td>
					
						<td>${fieldValue(bean: commentInstance, field: "trek")}</td>
